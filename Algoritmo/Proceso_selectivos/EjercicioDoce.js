...
//  Leer monto_factura
//  Escribir "Ingrese el porcentaje del IVA aplicado (en porcentaje sin el símbolo '%'):"
//  Leer porcentaje_iva
...
function IVA(){
    ...
    monto_factura = prompt("Ingresa el monto total de la factura: ")
    monto_factura = parseFloat(monto_factura)
    porcentaje_iva = prompt("Ingrese el porcentaje del IVA aplicado (en porcentaje sin el símbolo '%'):")
