...
//  presupuesto_sin_iva = numero_de_personas * costo_por_persona
//  presupuesto_con_iva = presupuesto_sin_iva * 1.15
//  Escribir "El presupuesto para el cliente es: $", presupuesto_con_iva
// FinProceso
// FinAlgoritmo
...
function somos_mas(){
    ...
    presupuesto_sin_iva = numero_de_personas * costo_por_persona
    presupuesto_con_iva = presupuesto_sin_iva * 1.15
    write("El presupuesto para el cliente es: $", presupuesto_con_iva.toFixed(2))
